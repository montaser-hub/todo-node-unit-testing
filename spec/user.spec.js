...
describe("user routes", () => {
    ...
    let userInDB
    it("expect get(/user) to res has all users", async () => {
    ...
    it("expect post(/user/signup) and valid user then getting res ", async () => {
        let res = await req.post("/user/signup").send({name:"xxx",password:"123"})
